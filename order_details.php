...
<head>
    ...
    <style>
        ...
        .container { width: 70%; margin: auto; background: white; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
        ...
        .btn-print { background-color: #28a745; margin-top: 1%; margin-left: 20%; margin-top:-4%; }
        .btn-print:hover { background-color: #218838; }
        .btn-back { background-color: rgb(61, 64, 62); }
        .btn-back:hover { background-color: rgb(49, 50, 49); }
        .btn-container { margin-top: 20px; }
        .btn-container button i { margin-right: 8px; } /* Add space between icon and text */
        .success-message { background-color: #28a745; color: white; padding: 10px; margin-bottom: 20px; text-align: center; border-radius: 5px; }
    </style>
</head>
<body>
    <div class="container">
